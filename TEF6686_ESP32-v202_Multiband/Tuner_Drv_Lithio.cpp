...
{
  return devTEF_Set_Cmd(TEF_AM, Cmd_Set_Bandwidth, 11, mode, bandwidth, control_sensitivity, low_level_sensitivity);
}

bool devTEF_Radio_Set_LevelOffset(int16_t offset)
{
  return devTEF_Set_Cmd(TEF_FM, Cmd_Set_LevelOffset, 5, offset);
}
